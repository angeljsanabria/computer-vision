"""
Prepara imagenes de calibracion INT8/hybrid para nozzle_bidones RKNN v7.
...
Uso (desde la raiz del repo):
  ...
  python yolo_train/prepare_nozzle_calib_v7.py --max-images 200
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=f"Calib {nc.RKNN_INPUT_SIZE} stretch para RKNN nozzle_bidones v7."
    )
    ...
    print("Siguiente: python yolo_train/exp_yolov8n_nozzle_rknn_v7.py")
