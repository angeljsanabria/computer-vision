...
Layout del proyecto (raiz = padre de wip/; ej. anpr-core):
  ./model/RetinaFace_mobile320_2.rknn
  ./test/test.jpg
  ./wip/RetinaFace_lite.py   <- este script

Por defecto usa model/ y test/ en la raiz (un .parent desde wip/).

Ejemplo:
  cd /home/myir/Documents/git-ctk/anpr-core/wip
  python3 detect_retinaface_img.py
...
# Umbral debil antes del NMS (alineado con demo Zoo RetinaFace).
RETINAFACE_SCORE_PRE_NMS = 0.02
# Umbral final sobre la cara: la utilidad solo devuelve filas con score >= este valor.
RETINAFACE_SCORE_DETECCION = 0.2


if __name__ == "__main__":
    # Script en .../wip/detect_retinaface_img.py -> padre = .../anpr-core/
