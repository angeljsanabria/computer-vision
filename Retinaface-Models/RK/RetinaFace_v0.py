...
if __name__ == '__main__':
    _rk_dir = Path(__file__).resolve().parent
    _default_rknn = _rk_dir / "model" / "RetinaFace_mobile320.rknn"
    _default_img = _rk_dir / "model" / "test.jpg"
    _default_out = _rk_dir / "result.jpg"
    ...
    parser.add_argument(
        ...
        help='Ruta al .rknn (defecto: model/RetinaFace_mobile320.rknn junto a este script)',
    )
    parser.add_argument(
        '--img',
        type=str,
        default=str(_default_img),
        help='Imagen de entrada (defecto: model/test.jpg)',
    )
    parser.add_argument(
        '--out',
        type=str,
        default=str(_default_out),
        help='Imagen de salida (defecto: result.jpg en esta carpeta)',
    )
    parser.add_argument(
        '--target',
        type=str,
        default='rk3568',
        help='Plataforma RKNPU (ej. rk3568)',
    )
